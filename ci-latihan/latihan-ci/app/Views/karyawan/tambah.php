...
<body>
    <div class="container">
        ...
        <?= form_open('form') ?>
        <form action="<?= base_url('karyawan/store') ?>" method="post" enctype="">
            <div class="form-group">
                <label for="exampleFormControlInput1">Nama</label>
                <input type="text" name="nama" class="form-control" id="exampleFormControlInput1" placeholder="Nama Lrngkap">
            </div>
            <div class="form-group">
