            ...
            <div class="col-sm-4">
                <div class="card text-center" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="persegi.php" class="btn btn-primary">Mulai Menghitung</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card text-center" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="segitiga.php" class="btn btn-primary">Mulai Menghitung</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card text-center" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="lingkaran.php" class="btn btn-primary">Mulai Menghitung</a>
                    </div>
                </div>
            </div>
        </div>
